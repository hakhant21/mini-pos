export default {
    ...
    products: {
        ...
        stock_package_unit: "Stock package unit",
        quick_update_hint: "Enter packages and loose {unit}s. Loose quantities are converted automatically.",
        packages: "Packages",
